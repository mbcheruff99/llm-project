...
def extract_double_brace(text):
  """Extracts three pieces of text inside [[...]] separated by '|'. Returns a tuple (part1, part2, part3) or None if no match."""
...
while user_input != "exit":
  ...
  email_data = extract_double_brace(response.output_text)
  if email_data: 
